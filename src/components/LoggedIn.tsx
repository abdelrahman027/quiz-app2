...
const LoggedIn = ({onSelect}:{onSelect:()=>void}) => {
  return (
    <div className='text-white mt-12 bg-black/40 p-6 w-1/3 mx-auto rounded-lg backdrop-blur flex items-center justify-center flex-col gap-12'>
      <div>
      <img src={logo} className="w-32" alt="Logo" />
    </div>

        <h4 className='text-2xl'>Submit form below then start the game </h4>
